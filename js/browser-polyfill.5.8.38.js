...
})(
  {
    ...
    3: [
      function(_dereq_, module, exports) {
        ...
        if (ArrayProto[UNSCOPABLES] == undefined)
          _dereq_(31)(ArrayProto, UNSCOPABLES, {});
      ...
      function(_dereq_, module, exports) {
        ...
        module.exports = function(
          ...
          if (
            ...
            IS_WEAK ||
              instance.forEach(function(val, key) {
      ...
      function(_dereq_, module, exports) {
        ...
        module.exports = function(/* ...pargs */) {
          ...
          return function(/* ...args */) {
            ...
            args = pargs.slice();
            if (holder)
              for (; length > j; j++) if (args[j] === _) args[j] = $$[k++];
      ...
      function(_dereq_, module, exports) {
        ...
        if (!DESCRIPTORS) {
          ...
          $.getDesc = function(O, P) {
            ...
            if (has(O, P))
              return createDesc(
                !ObjectProto.propertyIsEnumerable.call(O, P),
                O[P]
              );
          };
    ...
    97: [
      function(_dereq_, module, exports) {
        ...
        $export(
          $export.S +
            $export.F *
              !($acosh && Math.floor($acosh(Number.MAX_VALUE)) == 710),
          "Math",
          {
    ...
    126: [
      function(_dereq_, module, exports) {
        ...
        _dereq_(54)("getOwnPropertyDescriptor", function(
    ...
    138: [
      function(_dereq_, module, exports) {
        ...
        $export(
          $export.S + $export.F * (!USE_NATIVE || testResolve(true)),
          PROMISE,
          {
      ...
      function(_dereq_, module, exports) {
        ...
        $export(
          $export.S +
            $export.F *
              _dereq_(24)(function() {
                Reflect.defineProperty($.setDesc({}, 1, { value: 1 }), 1, {
                  value: 2
                });
              }),
          "Reflect",
      ...
      function(_dereq_, module, exports) {
        ...
        function set(target, propertyKey, V /*, receiver*/) {
          ...
          if (has(ownDesc, "value")) {
            ...
            existingDescriptor =
              $.getDesc(receiver, propertyKey) || createDesc(0);
        ...
        $export($export.P + $export.F * _dereq_(23)(STARTS_WITH), "String", {
          startsWith: function startsWith(searchString /*, position = 0 */) {
            var that = context(this, searchString, STARTS_WITH),
              $$ = arguments,
              index = toLength(
                Math.min($$.length > 1 ? $$[1] : undefined, that.length)
              ),
              search = String(searchString);
            return $startsWith
    ...
    185: [
      function(_dereq_, module, exports) {
        ...
        var global = _dereq_(29),
          ...
          ArrayValues = (Iterators.NodeList = Iterators.HTMLCollection =
            Iterators.Array);
